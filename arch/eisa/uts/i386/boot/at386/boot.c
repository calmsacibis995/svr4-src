...
#ident	"@(#)eisa:uts/i386/boot/at386/boot.c	1.3.1.1"
...
main()
{
	 ...
	 */
#ifdef	EISA
	if ( (prdcmos(0x12) & 0xf0) == 0xf0) 
			scsidiskflag = (prdcmos(0x19) == 0x2e);
	else if ( (prdcmos(0x12) & 0x0f) == 0x0f) 
			scsidiskflag = (prdcmos(0x1a) == 0x2f);
#else
