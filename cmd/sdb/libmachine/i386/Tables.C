#ident	"@(#)sdb:libmachine/i386/Tables.C	1.3"
...
/*  [4]  */	{"verr",TERM,M,0},	{"verw",TERM,M,0},	{"wbinvld",TERM,M,0},	{"invlpg",TERM,M,0},		
};
...
/*  [A4]  */	{"shld",TERM,DSHIFT,1},	{"shld",TERM,DSHIFTcl,1}, {"cmpxchg",TERM,RMw,0}, {"cmpxchg",TERM,RMw,1},
...
/*  [C0]  */	{"xadd",TERM,MRw,0},	{"xadd",TERM,MRw,1},	INVALID, INVALID,
/*  [C4]  */	INVALID,	INVALID,	INVALID,	INVALID,
/*  [C8]  */	{"bswp",TERM,R,0},	{"bswp",TERM,R,0}, {"bswp",TERM,R,0},	{"bswp",TERM,R,0},
/*  [CC]  */	{"bswp",TERM,R,0},	{"bswp",TERM,R,0}, {"bswp",TERM,R,0},	{"bswp",TERM,R,0},
};
