...
#ident	"@(#)ucbshutdown:shutdown.mk	1.3.1.1"
...
LDFLAGS = -s $(SHLIBS) -lnsl -lsocket $(LIB_OPT) -lucb
...
$(MAINS):	shutdown.o mountxdr.o
	$(CC) $(CFLAGS) -o shutdown shutdown.o mountxdr.o $(LDFLAGS)
...
install:	ALL
	install -f $(DIR) -m 555 -u bin -g bin shutdown 
